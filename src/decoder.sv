...
// > OPTIMIZATION: Decoding is purely combinational (no clock/core_state gating).
//   This lets the register file read its operands in the very same cycle the
//   instruction is decoded (see registers.sv / scheduler.sv), folding what used
//   to be two sequential DECODE + REQUEST cycles into a single cycle.
module decoder (
    ...
    always @(*) begin
        ...
        // Control signals default to 0 and are set conditionally by instruction
